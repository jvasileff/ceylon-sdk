...
shared Whole zero = Whole.Internal(0, wordListOfOne(0));

"A `Whole` instance representing one."
shared Whole one = Whole.Internal(1, wordListOfOne(1));

"A `Whole` instance representing negative one."
Whole negativeOne = Whole.Internal(-1, wordListOfOne(1));

"A `Whole` instance representing two."
shared Whole two = Whole.Internal(1, wordListOfOne(2));
